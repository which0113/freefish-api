...
import com.which.api.model.dto.user.UserQueryRequest;
import com.which.api.model.entity.User;
import com.which.api.model.enums.UserRoleEnum;
import com.which.api.model.vo.LoginUserVO;
...
import static com.which.api.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "which";
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        return this.getLoginUserVO(userVO);
    }
